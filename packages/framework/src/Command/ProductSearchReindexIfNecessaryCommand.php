...
class ProductSearchReindexIfNecessaryCommand extends Command
{
    /**
     * @var string
     */
    protected static $defaultName = 'shopsys:product-search:reindex-if-necessary';
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $output->writeln('Reindexing indexes');
        $this->productSearchExportStructureFacade->reindexIndexesIfNecessary($output);
        $symfonyStyleIo->success('Indexes reindexed successfully!');
    }
}
